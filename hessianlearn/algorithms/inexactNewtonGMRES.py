...
from ..algorithms import Optimizer, GMRESSolver, ParametersGMRESSolver
...
def ParametersInexactNewtonGMRES(parameters = {}):
	...
	parameters['gmres_parameters']					= [ ParametersGMRESSolver(),'CG Parameters']
...
class InexactNewtonGMRES(Optimizer):
	...
	def minimize(self,feed_dict = None,hessian_feed_dict = None):
		...
		if self.parameters['globalization'] == 'line_search':
			w_dir,on_boundary = self.gmres_solver.solve(-self.gradient,hessian_feed_dict)
