...
architecture['output_shape'] = data._output_shape
layer_dims = [100,50,20]
architecture['layer_dimensions'] = layer_dims 

NN = GenericDNN(architecture)
problem = AutoencoderProblem(NN,dtype=tf.float32)
